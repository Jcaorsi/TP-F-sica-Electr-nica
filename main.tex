...
\section{Análisis del dispositivo BJT (BC546B )}
    ...
    El punto de operación Q en la curva de entrada del BJT (figura \ref{fig:curvaEntradaBJT}) se encuentra determinado por la fuente de tensión $V_{GS}=620\,mV$ colocada. La simulación mostró que en este punto, $I_D=523.6\,\mu A$. 
